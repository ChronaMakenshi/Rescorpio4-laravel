...
return [
    ...
    'custom'               => [
        'g-recaptcha-response' => [
            'captcha'  => 'Captcha-Fehler! Versuchen Sie es später noch einmal oder kontaktieren Sie den Website-Administrator.',
            'required' => 'Bitte überprüfen Sie, dass Sie kein Roboter sind.',
        ],
    ],
];
